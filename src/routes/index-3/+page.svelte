				...
				<div class="container">
					...
					<div class="primary-nav">
						...
						<div class="menu-init" id="navigation">
							<button
								class="btn btn--icon toggle-button toggle-button--white fas fa-cogs"
								type="button"
							></button>
				...
				<div class="container">
					...
					<div class="secondary-nav">
						...
						<div class="menu-init" id="navigation2">
							<button
								class="btn btn--icon toggle-button toggle-button--white fas fa-cog"
								type="button"
							></button>
								...
								<ul class="ah-list ah-list--design2 ah-list--link-color-white">
									...
									<li class="has-dropdown">
										...
										<ul style="width:170px">
											...
											<li class="has-dropdown has-dropdown--ul-left-100">
												<a href="dashboard.html"
													>Dashboard<i class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a
												>
												...
												<ul style="width:200px">
													<li class="has-dropdown has-dropdown--ul-left-100">
														<a href="dashboard.html"
															>Manage My Account<i class="fas fa-angle-down i-state-right u-s-m-l-6"
															></i></a
														>
													...
													<li class="has-dropdown has-dropdown--ul-left-100">
														<a href="dash-address-book.html"
															>Address Book<i class="fas fa-angle-down i-state-right u-s-m-l-6"
															></i></a
														>
											...
											<li class="has-dropdown has-dropdown--ul-left-100">
												<a
													>Product Details<i class="fas fa-angle-down i-state-right u-s-m-l-6"
													></i></a
												>
											...
											<li class="has-dropdown has-dropdown--ul-left-100">
												<a
													>Shop Grid Layout<i class="fas fa-angle-down i-state-right u-s-m-l-6"
													></i></a
												>
											...
											<li class="has-dropdown has-dropdown--ul-left-100">
												<a
													>Shop List Layout<i class="fas fa-angle-down i-state-right u-s-m-l-6"
													></i></a
												>
										...
										<div class="mini-cart">
											...
											<div class="mini-product-stat">
												...
												<div class="mini-action">
													<a class="mini-link btn--e-brand-b-2" href="checkout.html"
														>PROCEED TO CHECKOUT</a
													>

													<a class="mini-link btn--e-transparent-secondary-b-2" href="cart.html"
														>VIEW CART</a
													>
												</div>
											</div>
							...
							<div class="row">
								<div class="col-12">
									<div class="slider-content slider-content--animation">
										...
										<a class="shop-now-link btn--e-brand" href="shop-side-version-2.html"
											>SHOP NOW</a
										>
									</div>
								</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
							<div class="promotion-o">
								...
								<div class="promotion-o__content">
									<a class="promotion-o__link btn--e-white-brand" href="shop-side-version-2.html"
										>Women's Clothing</a
									>
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-12">
								<a class="i3-banner" href="shop-side-version-2.html">
									<div class="aspect aspect--bg-grey-fb aspect--square">
										<img
											class="aspect__img i3-banner__img"
											src="images/banners/i3-banner-1.jpg"
											alt=""
										/>
									</div>
								</a>
										...
										<div class="product-short u-h-100">
											<div class="product-short__container">
												<div class="product-short__img-wrap">
													<a
														class="aspect aspect--bg-grey-fb aspect--square u-d-block"
														href="product-detail.html"
													>
														<img
															class="aspect__img product-short__img"
									...
									<div class="col-lg-12">
										<a class="i3-banner" href="shop-side-version-2.html">
											<div class="aspect aspect--bg-grey-fb aspect--1048-334">
												<img
													class="aspect__img i3-banner__img"
													src="images/banners/i3-banner-2.jpg"
													alt=""
												/>
											</div>
										</a>
						...
						<div class="col-lg-12">
							<div class="section__text-wrap">
								...
								<span class="section__span u-c-silver u-s-m-b-16"
									>FIND PRODUCTS THAT ARE MOST SELLING</span
								>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-12">
							<div class="filter-category-container">
								<div class="filter__category-wrapper">
									<button
										class="btn filter__btn filter__btn--style-2 js-checked"
										type="button"
								...
								<div class="filter__category-wrapper">
									<button
										class="btn filter__btn filter__btn--style-2"
										type="button"
											...
											<div class="product-bs__container">
												...
												<div class="product-bs__rating gl-rating-style">
													<i class="fas fa-star"></i><i class="fas fa-star"></i><i
														class="fas fa-star"
													></i><i class="fas fa-star"></i><i class="far fa-star"></i>

													<span class="product-bs__review">(23)</span>
												</div>

												<span class="product-bs__price"
													>$125.00
								...
								<div class="product-short__container">
									<div class="product-short__img-wrap">
										...
										>
											<img
												class="aspect__img product-short__img"
												src="images/product/women/product16.jpg"
												alt=""
											/></a
										>
									</div>
								...
								<div class="product-short__container">
									<div class="product-short__img-wrap">
										...
										>
											<img
												class="aspect__img product-short__img"
												src="images/product/women/product17.jpg"
												alt=""
											/></a
										>
									</div>
								...
								<div class="product-short__container">
									<div class="product-short__img-wrap">
										...
										>
											<img
												class="aspect__img product-short__img"
												src="images/product/women/product18.jpg"
												alt=""
											/></a
										>
									</div>
								...
								<div class="product-short__container">
									<div class="product-short__img-wrap">
										...
										>
											<img
												class="aspect__img product-short__img"
												src="images/product/women/product19.jpg"
												alt=""
											/></a
										>
									</div>
										...
										<div class="product-l">
											...
											<div class="product-l__info-wrap">
												<div class="product-l__rating gl-rating-style">
													<i class="fas fa-star"></i><i class="fas fa-star"></i><i
														class="fas fa-star"
													></i><i class="far fa-star"></i><i class="far fa-star"></i>
												</div>
					...
					<div class="slider-fouc">
						<div class="owl-carousel" id="brand-slider" data-item="5">
							<div class="brand-slide">
								<a href="shop-side-version-2.html"> <img src="images/brand/b1.png" alt="" /></a>
							</div>
							<div class="brand-slide">
								<a href="shop-side-version-2.html"> <img src="images/brand/b2.png" alt="" /></a>
							</div>
							<div class="brand-slide">
								<a href="shop-side-version-2.html"> <img src="images/brand/b3.png" alt="" /></a>
							</div>
							<div class="brand-slide">
								<a href="shop-side-version-2.html"> <img src="images/brand/b4.png" alt="" /></a>
							</div>
							<div class="brand-slide">
								<a href="shop-side-version-2.html"> <img src="images/brand/b5.png" alt="" /></a>
							</div>
							<div class="brand-slide">
								<a href="shop-side-version-2.html"> <img src="images/brand/b6.png" alt="" /></a>
							</div>
						</div>
					</div>
					<!--====== End - Brand Slider ======-->
						...
						<div class="outer-footer__content">
							...
							<form class="newsletter">
								...
								<span class="newsletter__text"
									>Subscribe to the mailing list to receive updates on promotions, new arrivals,
									discount and coupons.</span
								>
							</form>
						</div>
					</div>
							...
							<div class="pd-detail">
								...
								<div>
									<div class="pd-detail__inline">
										...
										<span class="pd-detail__discount">(76% OFF)</span><del class="pd-detail__del"
											>$28.97</del
										>
									</div>
								</div>
								<div class="u-s-m-b-15">
									<div class="pd-detail__rating gl-rating-style">
										...
										></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
						...
						<div class="col-lg-6 new-l__col-2">
							<div class="new-l__section u-s-m-t-30">
								...
								<div class="u-s-m-b-15 new-l--center">
									<p class="new-l__p2">
										By Signing up, you agree to receive Reshop offers,<br />promotions and other
