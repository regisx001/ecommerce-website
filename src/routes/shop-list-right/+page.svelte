					...
					<div class="shop-p">
						...
						<div class="u-s-p-y-60">
							...
							<ul class="shop-p__pagination">
								<li class="is-active">
									<a href="shop-list-right.html">1</a>
								</li>
								<li>
									<a href="shop-list-right.html">2</a>
								</li>
								<li>
									<a href="shop-list-right.html">3</a>
								</li>
								<li>
									<a href="shop-list-right.html">4</a>
								</li>
								<li>
									<a class="fas fa-angle-right" href="shop-list-right.html"></a>
								</li>
							</ul>
							<!--====== End - Pagination ======-->
						</div>
						...
						<div class="shop-w-master__sidebar sidebar--bg-snow">
							<div class="u-s-m-b-30">
								<div class="shop-w">
									...
									<div class="shop-w__wrap show collapse" id="s-category">
										<ul class="shop-w__category-list gl-scroll">
											<li class="has-list">
												...
												<span class="js-shop-category-span is-expanded fas fa-plus u-s-m-l-6"
												></span>
							...
							<div class="u-s-m-b-30">
								<div class="shop-w">
									...
									<div class="shop-w__wrap show collapse" id="s-rating">
							...
							<div class="u-s-m-b-30">
								<div class="shop-w">
									...
									<div class="shop-w__wrap show collapse" id="s-shipping">
										<ul class="shop-w__list gl-scroll">
											<li>
												<!--====== Check Box ======-->
												<div class="check-box">
							...
							<div class="u-s-m-b-30">
								<div class="shop-w">
									...
									<div class="shop-w__wrap show collapse" id="s-price">
							...
							<div class="u-s-m-b-30">
								<div class="shop-w">
									...
									<div class="shop-w__wrap show collapse" id="s-manufacturer">
							...
							<div class="u-s-m-b-30">
								<div class="shop-w">
									...
									<div class="shop-w__wrap show collapse" id="s-color">
										<ul class="shop-w__list gl-scroll">
											<li>
							...
							<div class="u-s-m-b-30">
								<div class="shop-w">
									<div class="shop-w__intro-wrap">
										...
										<span
											class="fas fa-minus collapsed shop-w__toggle"
											data-target="#s-size"
											data-toggle="collapse"
										></span>
									</div>
