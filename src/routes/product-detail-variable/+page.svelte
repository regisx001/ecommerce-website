								...
								<div class="u-s-m-b-15">
									...
									<div class="pd-detail__color">
										<div class="color__radio">
											...
											<label class="color__radio-label" for="jet" style="background-color: #333333"
											></label>
										</div>
										<div class="color__radio">
						...
						<div class="tab-content">
							...
							<div class="tab-pane" id="pd-tag">
								<div class="pd-tab__tag">
									...
									<span class="gl-text"
										>Use spaces to separate tags. Use single quotes (') for phrases.</span
									>
								</div>
							</div>
							<!--====== End - Tab 2 ======-->
									...
									<div class="u-s-m-b-30">
										<form class="pd-tab__rev-f2">
															...
															<tr>
																...
																<th>
																	<div class="gl-rating-style-2">
																		<i class="fas fa-star"></i><i class="fas fa-star"></i><i
																			class="fas fa-star"
																		></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"
																		></i>
											...
											<div class="rev-f2__group">
												<div class="u-s-m-b-15">
													<label class="gl-label" for="reviewer-text">YOUR REVIEW *</label><textarea
